		...
		<>
			...
			<section className="personal-info-section">
				<div className="personal-info-section__container container">
					<nav>
						<div className="nav nav-tabs" id="nav-tab" role="tablist">
							<button
								...
								id="personal-tab-1"
								data-bs-toggle="tab"
								data-bs-target="#personal-tabs-1"
								type="button"
								role="tab"
								aria-controls="personal-tabs-1"
								aria-selected="true"
							>
								Личные данные
							</button>
							<button
								...
								id="personal-tab-2"
								data-bs-toggle="tab"
								data-bs-target="#personal-tabs-2"
								type="button"
								role="tab"
								aria-controls="personal-tabs-2"
								aria-selected="false"
							>
								Финансы
							</button>
							<button
								...
								id="personal-tab-3"
								data-bs-toggle="tab"
								data-bs-target="#personal-tabs-3"
								type="button"
								role="tab"
								aria-controls="personal-tabs-3"
								aria-selected="false"
							>
								Соц сети
							</button>
							<button
								...
								id="personal-tab-4"
								data-bs-toggle="tab"
								data-bs-target="#personal-tabs-4"
								type="button"
								role="tab"
								aria-controls="personal-tabs-4"
								aria-selected="false"
							>
								Оповещения
							</button>
							<button
								...
								id="personal-tab-5"
								data-bs-toggle="tab"
								data-bs-target="#personal-tabs-5"
								type="button"
								role="tab"
								aria-controls="personal-tabs-5"
								aria-selected="false"
							>
								Безопасность
							</button>
							<button
								...
								id="personal-tab-6"
								data-bs-toggle="tab"
								data-bs-target="#personal-tabs-6"
								type="button"
								role="tab"
								aria-controls="personal-tabs-6"
								aria-selected="false"
							>
								Купить рекламу
							</button>
							<button
								...
								id="personal-tab-7"
								data-bs-toggle="tab"
								data-bs-target="#personal-tabs-7"
								type="button"
								role="tab"
								aria-controls="personal-tabs-7"
								aria-selected="false"
							>
								Моя реклама
							</button>
					...
					<div className="personal-info-section__tab-content tab-content" id="nav-tabContent">
						<div
							className="personal-info-section__tab-pane tab-pane fade show active"
							id="personal-tabs-1"
							role="tabpanel"
							aria-labelledby="personal-tab-1"
						>
							...
							<div className="personal-info-section__forms">
								<form action="" method="post" className="personal-info-section__form">
									...
									<div className="personal-info-section__input form-floating mb-3">
										<input type="phone" className="form-control" id="floatingPhone" placeholder="Phone" required />
									...
									<button className="personal-info-section__btn" type="button">
										Сменить
									</button>
								</form>
							</div>
						...
						<div
							className="personal-info-section__tab-pane tab-pane fade"
							id="personal-tabs-2"
							role="tabpanel"
							aria-labelledby="personal-tab-2"
						>
						...
						<div
							...
							id="personal-tabs-3"
							role="tabpanel"
							aria-labelledby="personal-tab-3"
						>
						...
						<div
							...
							id="personal-tabs-4"
							role="tabpanel"
							aria-labelledby="personal-tab-4"
						>
							<div className="personal-info-section__tab-alerts">
								<div className="personal-info-section__tab-alert">
									<h4>Заголовок</h4>
									<p>
										Lorem ipsum dolor sit amet consectetur adipisicing elit. Quaerat voluptatibus velit exercitationem
										quis magnam alias libero nobis facere ipsa accusantium quas ea numquam obcaecati molestias sapiente
										harum, ab sequi iste.
									</p>
								</div>
								<div className="personal-info-section__tab-alert">
						...
						<div
							...
							id="personal-tabs-5"
							role="tabpanel"
							aria-labelledby="personal-tab-5"
						>
							<div className="personal-info-section__tab-safety">
								<form action="" method="post" className="personal-info-section__form">
									...
									<div className="personal-info-section__form-item mb-3">
						...
						<div
							...
							id="personal-tabs-6"
							role="tabpanel"
							aria-labelledby="personal-tab-6"
						>
							<div className="personal-info-section__tab-buy">
								<ul className="personal-info-section__tab-buy-list nav nav-pills mb-3" id="pills-tab" role="tablist">
								...
								<div className="tab-content" id="pills-tabContent">
									...
									<div className="tab-pane fade show" id="pills-item" role="tabpanel" aria-labelledby="pills-item-tab">
										<a className="personal-info-section__tab-buy-link" href="#">
											Информация
										</a>
									</div>
						...
						<div
							...
							id="personal-tabs-7"
							role="tabpanel"
							aria-labelledby="personal-tab-7"
						>
